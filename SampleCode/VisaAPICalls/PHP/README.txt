...
===================================================== 
1. Log on to beta.developer.visa.com and click on your app name
2. Copy the APIKey and Shared secret to any text editor
3. Download the sample code CybersourceSample.php or VisaCheckoutSample.php to your local folder
4. Replace "put your api key here" with the APIKey from step 3
5. Replace "put your shared secret here" with the Shared Secret from step 3
...
4. Download the sample code VisaDirectSample.php to your local folder
