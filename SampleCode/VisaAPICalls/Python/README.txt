...
4. Download the sample code Cybersourcesample.py or VisaCheckoutsample.py to your local folder
...
4. Download the sample code VisaDirectsample.py to your local folder
